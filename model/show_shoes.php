...
class show_shoes
{
    ...
    protected static $sizeString = "something";
    private $sqlCheck;
    public function outValue($value1, $value2, $value3)
    {
        self::$sizeString = '';
        // htmlspecialchars_decode &quot to " and &amp to & like that
...
//        $sql = "SELECT * FROM shop.products WHERE ".$this->sizeString." ORDER BY createdDate DESC LIMIT 6";
     ...
     * ***********
     * */
    public function paginationHandle($page){
        $this->page = htmlspecialchars_decode($page);
        $this->page = html_entity_decode($this->page);
        $this->page = json_decode($this->page);

        if(empty(self::$sizeString)){

//            return $sql = "SELECT * FROM shop.products WHERE ".$this->sizeString." ORDER BY createdDate DESC LIMIT 6";
    ...
    public function outValue2($value1, $value2, $value3)
    {
        ...
        $this->val2 = $value2;
        $this->val3 = $value3;
        self::$sizeString = "this is inside sizeString";
    }
